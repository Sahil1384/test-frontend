              ...
              <div className="col-lg-6">
                <ul className="list-inline">
                  <li className="list-inline-item">
                    <h5 className="mt-0">
                      Here the list of all Payment Status.{" "}
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Our Payment Status</h4>
                      </div>
                    </div>
                  </div>
                      ...
                      <table className="table table-striped">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Otto</td>
                            <td>
                            <button className="p-1" onClick={()=>navigate('/edit-payment-status')}><i className="las la-pen text-secondary font-16"></i></button>
                                  &nbsp;&nbsp;
                          ...
                          <tr>
                            ...
                            <td>Thornton</td>
                            <td>
                            <button className="p-1" onClick={()=>navigate('/sd-paid-status')}><i className="las la-pen text-secondary font-16"></i></button>
                                  &nbsp;&nbsp;
                            <button className="p-1"><i className="las la-trash-alt text-secondary font-6"></i></button>
                            </td>
                          </tr>
