                ...
                <div className="page-title-box">
                  <div className="float-end">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active">Material Accepted</li>
                    </ol>
                  </div>
                  <h4 className="page-title">Accepted Material</h4>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-lg-6">
                <ul className="list-inline">
                  <li className="list-inline-item">
                    <h5 className="mt-0">
                      Here the list of all Accepted Material.{" "}
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Our Accepted Material</h4>
                      </div>
                    </div>
                  </div>
                      ...
                      <table className="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Thornton</td>
                            <td>
                            <button className="p-1" onClick={()=>navigate('/edit-accepted-material')}><i className="las la-pen text-secondary font-16"></i></button>
                                  &nbsp;&nbsp;
                            <button className="p-1"><i className="las la-trash-alt text-secondary font-6"></i></button>
                            </td>
                          </tr>
