                                ...
                                <div class="page-title-box">
                                    <div class="float-end">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><Link to="#!">Project /</Link>
                                            </li>
                                            ...
                                            <div class="card-body">
                                                <div class="row d-flex">
                                                    ...
                                                    <div class="col-12 ms-auto align-self-center">
                                                        ...
                                                        <p class="text-muted mb-0 fw-semibold">Employee strength</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="dropdown">
                                                            <Link to="#" class="btn btn-sm btn-outline-light dropdown-toggle"
