          ...
          <div className="container-fluid">
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-6" >
                  <div className="card team-card department-card">
                    <div className="card-body">
                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <div className="d-flex align-items-center gap-1">
                          <i className="fa fa-user"></i>
                          <div>
                            <h4 className="m-0 fw-bold">Backend Department</h4>
                            <h6 className="fw-bold">Backend @acme india.com</h6>
                          </div>
                        </div>
                        <div>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <div>
                          <h5 className="mb-1 fw-bold">Project Type</h5>
                          <h3 className="fw-bold">Believe in yourself and you'll be unstoppable.</h3>
                        </div>
                        <div>
                          <button className="d-block edit--btn"><i className="fa fa-edit "></i></button>
                          <button className="d-block delete--btn"><i className="fa fa-trash "></i></button>
                        </div>
                      </div>

                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <h3 className="fw-bolder">Guddu</h3>
                        <div className="mx-5">
                          <img src="assets/images/small/project-2.jpg" alt="" className="rounded-circle thumb-sm" />
                          <img src="assets/images/small/project-2.jpg" alt="" className="rounded-circle thumb-sm" />
                          <img src="assets/images/small/project-2.jpg" alt="" className="rounded-circle thumb-sm" /> <img src="assets/images/small/project-2.jpg" alt="" className="rounded-circle thumb-sm" />
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-2">
                        <div className="d-flex gap-1">
                          <h5 className="fw-bold">Unti,</h5>
                          <h5 className="fw-bold">Vaikunth,</h5>
                          <h5 className="fw-bold">Fojfit,</h5>
                        </div>
                        <div>
                          <h5 className="fw-bold">View Details<i className="fa fa-arrow-right"></i></h5>
                        </div>
                      </div>
